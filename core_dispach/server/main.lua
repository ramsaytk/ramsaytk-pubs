...
AddEventHandler("core_dispach:playerStatus", function(status)
        local src = source
...
QBCore.Functions.CreateCallback("core_dispach:getPersonalInfo", function(source, cb)
...
QBCore.Functions.CreateCallback("core_dispach:getInfo", function(source, cb)
        local generated = {}
...
QBCore.Functions.CreateCallback("core_dispach:getUnits", function(source, cb)
        local generated = {}
